...
namespace Microsoft.WimgApi
{
                ...
                if (raw != null)
                {
                    ...
                    try
                    {
                        ...
                        foreach (XmlNode node in xmlDocument.ChildNodes)
                        {
                            ...
                            {
                                if(childNode.Name.EqualsIgnoreCase(node.ToString()))
                                {
    ...
    ProcessFileEventArgs : EventArgs
    {
        ...
        ///<param name="skipFileFlag">Latest is false - skip file and continue.
        ...
        ///Latest is false - skip file and continue. Setting to true will
